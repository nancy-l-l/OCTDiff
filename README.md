...
<p align="center">
  <a href="https://openreview.net/forum?id=VN5bMTfSZS" target="_blank" rel="noopener noreferrer">
    <img src="Image%2012-23-25%20at%206.35%20PM.jpeg" width="520" alt="OCTDiff downstream classification results" />
  </a>
  <br/>
  <em>For full paper, Click Figure 1: Accuracy (%) on downstream disease classification using high-resolution images from
...
OCT devices, OCTDiff enhanced images. I performed 5-fold cross-validation for each
model-dataset pair, with the results shown in the Table above, and I conducted Mann–Whitney U tests
